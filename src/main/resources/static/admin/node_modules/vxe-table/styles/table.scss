...
.vxe-table--cell-active-area {
  border-color: $vxe-table-cell-active-area-border-color; 
  border-style: solid;
  border-width: $vxe-table-cell-active-area-border-width;
  background-color: $vxe-table-cell-active-area-background-color;
}
  ...
  .vxe-body--row {
    &.row--new {
      & > .vxe-body--column {
        ...
        &:before {
          content: "";
          top: $vxe-table-cell-dirty-width * -1;
          left: $vxe-table-cell-dirty-width * -1;
          position: absolute;
