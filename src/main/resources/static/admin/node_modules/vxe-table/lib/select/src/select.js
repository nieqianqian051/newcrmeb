...
function renderOption(h, _vm, list, group) {
  ...
  var optionSlot = $scopedSlots.option;
  return list.map(function (option, cIndex) {
    ...
    }, optionSlot ? _vm.callSlot(optionSlot, optParams, h) : defaultSlot ? _vm.callSlot(defaultSlot, optParams, h) : _utils.default.formatText((0, _utils.getFuncText)(option[labelField]))) : null;
  });
}
function renderOptgroup(h, _vm) {
  ...
  return visibleGroupList.map(function (group, gIndex) {
    ...
    }, optionSlot ? _vm.callSlot(optionSlot, optParams, h) : defaultSlot ? _vm.callSlot(defaultSlot, optParams, h) : (0, _utils.getFuncText)(group[groupLabelField])), h('div', {
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-select', className ? _xeUtils.default.isFunction(className) ? className({
        $select: this
      }) : className : '', _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "size--".concat(vSize), vSize), 'is--visivle', visiblePanel), 'is--disabled', disabled), 'is--filter', filterable), 'is--loading', loading), 'is--active', isActivated)]
    }, [h('div', {
      class: 'vxe-select-slots',
      ref: 'hideOption'
    }, defaultSlot ? defaultSlot.call(this, {}) : []), h('vxe-input', {
      ref: 'input',
      props: {
      ...
      class: ['vxe-table--ignore-clear vxe-select--panel', popupClassName ? _xeUtils.default.isFunction(popupClassName) ? popupClassName({
        $select: this
      }) : popupClassName : '', _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "size--".concat(vSize), vSize), 'is--transfer', this.transfer), 'animat--leave', !loading && this.animatVisible), 'animat--enter', !loading && visiblePanel)],
      attrs: {
    ...
    }, headerSlot.call(this, {})) : _e(), h('div', {
      class: 'vxe-select--panel-body'
    }, [h('div', {
      ref: 'optWrapper',
      class: 'vxe-select-option--wrapper'
    }, renderOpts(h, this))]), footerSlot ? h('div', {
  ...
  methods: {
    ...
    scrollToOption: function scrollToOption(option, isAlignBottom) {
      ...
      return this.$nextTick().then(function () {
        if (option) {
          ...
          var optElem = $refs.panel.querySelector("[optid='".concat(getOptid(_this4, option), "']"));
    ...
    handleFocusSearch: function handleFocusSearch() {
      ...
      if (this.filterable) {
        this.$nextTick(function () {
          if (_this5.$refs.inpSearch) {
            _this5.$refs.inpSearch.focus();
          }
        });
      }
    },
    ...
    showOptionPanel: function showOptionPanel() {
      ...
      if (!loading && !disabled) {
        ...
        setTimeout(function () {
          var value = _this7.value,
            multiple = _this7.multiple;
          var currOption = findOption(_this7, multiple && value ? value[0] : value);
          _this7.visiblePanel = true;
          if (currOption) {
            _this7.setCurrentOption(currOption);
            _this7.scrollToOption(currOption);
          }
          _this7.handleFocusSearch();
        }, 10);
        this.updateZindex();
        this.updatePlacement();
      }
