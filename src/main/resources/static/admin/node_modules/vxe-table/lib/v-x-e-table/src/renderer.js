 ...
 * @deprecated
 */
function getOldComponentName(_ref2) {
  var name = _ref2.name;
...
function oldButtonsEditRender(h, renderOpts, params) {
  return renderOpts.children.map(function (childRenderOpts) {
    return oldButtonEditRender(h, childRenderOpts, params)[0];
  });
}
...
function handleInputFilterMethod(_ref6) {
...
function getSelectCellValue(renderOpts, _ref7) {
  var row = _ref7.row,
    column = _ref7.column;
...
function oldFormItemRadioAndCheckboxRender(h, renderOpts, params) {
  ...
  var disabledProp = optionProps.disabled || 'disabled';
  var itemValue = _xeUtils.default.get(data, property);
  var name = getOldComponentName(renderOpts);
  // 如果是分组
  if (options) {
