...
function renderLine(h, _vm, $xetable, params) {
  ...
  var afterFullData = $xetable.afterFullData,
  ...
  var isFirstRow = $xetable.eqRow(afterFullData[0], row);
  if (treeConfig && treeNode && (treeOpts.showLine || treeOpts.line)) {
    return [h('div', {
      ...
      class: 'vxe-tree--line',
      style: {
        height: "".concat(isFirstRow ? 1 : (0, _util.calcTreeLine)(params, items, rIndex), "px"),
...
function renderColumn(h, _vm, $xetable, seq, rowid, fixedType, rowLevel, row, rowIndex, $rowIndex, _rowIndex, column, $columnIndex, columns, items) {
  ...
  var tableListeners = $xetable.$listeners,
    ...
    validErrorMaps = $xetable.validErrorMaps;
  ...
  if (fixedHiddenColumn && (allColumnOverflow ? isAllOverflow : allColumnOverflow)) {
    ...
    if (showValidTip && errorValidItem) {
      ...
      var validParams = _objectSpread(_objectSpread({}, params), errorValidItem);
      tdVNs.push(h('div', {
        class: ['vxe-cell--valid-error-hint', _utils.default.getClass(validOpts.className, errorValidItem)],
...
function renderRows(h, _vm, $xetable, fixedType, tableData, tableColumn) {
  var stripe = $xetable.stripe,
    ...
    expandOpts = $xetable.expandOpts,
    editOpts = $xetable.editOpts,
    treeExpandedMaps = $xetable.treeExpandedMaps,
    scrollYLoad = $xetable.scrollYLoad,
    rowExpandedMaps = $xetable.rowExpandedMaps,
    radioOpts = $xetable.radioOpts,
    checkboxOpts = $xetable.checkboxOpts,
    ...
    fullAllDataRowIdData = $xetable.fullAllDataRowIdData,
    rowOpts = $xetable.rowOpts,
    pendingRowList = $xetable.pendingRowList,
    pendingRowMaps = $xetable.pendingRowMaps;
  ...
  render: function render(h) {
    ...
    if ($scopedSlots.empty) {
      ...
      if (renderTableEmptyView) {
        emptyContent = (0, _vn.getSlotVNs)(renderTableEmptyView.call(this, h, emptyOpts, {
          $table: $xetable
        }));
      } else {
