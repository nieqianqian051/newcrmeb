  ...
  function ItemConfig($xeform, item) {
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      if (compConf && !(compConf.renderFormItemContent || compConf.renderItemContent) && compConf.renderItem) {
        (0, _log.warnLog)('vxe.error.delProp', ['item-render.renderItem', 'item-render.renderFormItemContent']);
      }
    }
  }
  return _createClass(ItemConfig, [{
    key: "update",
...
var handleFieldOrItem = exports.handleFieldOrItem = function handleFieldOrItem($xeform, fieldOrItem) {
  if (fieldOrItem) {
