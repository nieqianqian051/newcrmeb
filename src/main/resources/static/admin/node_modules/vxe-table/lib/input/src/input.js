...
function renderPanel(h, _vm) {
  ...
  if (isDatePickerType) {
    ...
    return h('div', {
      ref: 'panel',
      class: ['vxe-table--ignore-clear vxe-input--panel', "type--".concat(type), _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "size--".concat(vSize), vSize), 'is--transfer', transfer), 'animat--leave', animatVisible), 'animat--enter', visiblePanel)],
      attrs: {
  ...
  render: function render(h) {
    ...
    if (showWordCount && ['text', 'search'].includes(type)) {
      ...
      childs.push(h('span', {
        ...
        value: inputValue
      })) : "".concat(this.inputCount).concat(inpMaxlength ? "/".concat(inpMaxlength) : '')));
    }
    return h('div', {
      class: ['vxe-input', "type--".concat(type), className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "size--".concat(vSize), vSize), "is--".concat(align), align), 'is--controls', controls), 'is--prefix', !!prefix), 'is--suffix', !!suffix), 'is--readonly', readonly), 'is--visivle', visiblePanel), 'is--count', isWordCount), 'is--disabled', disabled), 'is--active', isActivated)]
    }, childs);
  },
  methods: {
    ...
    updatePlacement: function updatePlacement() {
      ...
      return this.$nextTick().then(function () {
        ...
        if (targetElem && panelElem) {
          ...
          console.log(_dom.default.getAbsolutePos(targetElem));
          if (transfer) {
