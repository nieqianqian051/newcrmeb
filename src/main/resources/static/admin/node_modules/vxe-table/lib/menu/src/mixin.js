...
var _default = exports.default = {
  methods: {
      ...
      if ((0, _utils.isEnableConf)(menuConfig) || contextMenu) {
        ...
        for (var index = 0; index < layoutList.length; index++) {
          ...
          if (columnTargetNode.flag) {
            ...
            this.handleOpenMenuEvent(evnt, layout, _params);
     ...
     * 显示快捷菜单
     */
    handleOpenMenuEvent: function handleOpenMenuEvent(evnt, type, params) {
      var _this = this;
    ...
    ctxMenuLinkEvent: function ctxMenuLinkEvent(evnt, menu) {
      ...
      if (!menu.disabled && (menu.code || !menu.children || !menu.children.length)) {
        var gMenuOpts = _vXETable.default.menus.get(menu.code);
