...
var _default = exports.default = {
  methods: {
     ...
     */
    _setFilter: function _setFilter(fieldOrColumn, options, update) {
      var column = (0, _util.handleFieldOrColumn)(this, fieldOrColumn);
      if (column && column.filters) {
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.column === column && filterStore.visible) {
        ...
        this.$nextTick(function () {
          ...
          var filterHeight = filterWrapperElem.offsetHeight;
          var filterHeadElem = filterWrapperElem.querySelector('.vxe-table--filter-header');
          var filterFootElem = filterWrapperElem.querySelector('.vxe-table--filter-footer');
          var centerWidth = filterWidth / 2;
          var minMargin = 10;
          var maxLeft = bodyElem.clientWidth - filterWidth - minMargin;
          var left, right;
          var style = {
            top: "".concat(targetElem.offsetTop + targetElem.offsetParent.offsetTop + targetElem.offsetHeight, "px")
          };
          // 判断面板不能大于表格高度
          var maxHeight = null;
          var bodyHeight = bodyElem.clientHeight - (headerElem ? headerElem.clientHeight / 2 : 0);
    ...
    _updateFilterOptionStatus: function _updateFilterOptionStatus(item, checked) {
