...
var _default = exports.default = {
  ...
  methods: {
    renderOptions: function renderOptions(h, filterRender, compConf) {
      ...
      var slots = column ? column.slots : null;
    ...
    renderFooter: function renderFooter(h) {
      var $xetable = this.$parent,
        hasCheckOption = this.hasCheckOption,
        filterStore = this.filterStore;
      var filterOpts = $xetable.filterOpts;
      ...
      }, filterOpts.confirmButtonText || _conf.default.i18n('vxe.table.confirmFilter')), h('button', {
        on: {
