...
var _default2 = exports.default = {
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['vxe-textarea', className, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "size--".concat(vSize), vSize), 'is--autosize', autosize), 'is--disabled', disabled), 'def--rows', !_xeUtils.default.eqNull(rows)), 'def--cols', !_xeUtils.default.eqNull(cols))]
    }, [h('textarea', {
      ref: 'textarea',
