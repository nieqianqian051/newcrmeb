        ...
        <div class="phone">
          ...
          >
            <div class="px-10 cup module" :class="{ active: active === 7 }"
                 @click="editMode(7)">
              <div class="bg--w111-fff h-104 flex text--w111-333 pl-16 pr-10 mb-50">
                ...
                <div class="flex-between-center flex-1">
                  <div class="w-108 h-36 flex-center join_cart rd-18px text--w111-fff fs-13">加入购物车</div>
                  <div class="w-108 h-36 flex-center pay_btn rd-18px text--w111-fff fs-13">立即购买</div>
                </div>
              </div>
            </div>
          </Tooltip>
